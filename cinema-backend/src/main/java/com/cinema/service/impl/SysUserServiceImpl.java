...
import com.cinema.common.utils.CaptchaUtil;
...
import com.cinema.mapper.SysUserMapper;
import com.cinema.service.SysUserService;
...
public class SysUserServiceImpl implements SysUserService {
    ...
    public LoginUser login(SysUserVo sysUserVo) {
        ...
        String token = JwtUtil.sign(user.getUserName(), user.getUserId(), user.getRoleId(), user.getPassword());
